...
"oui_player_bandcamp":https://github.com/NicolasGraph/oui_player_bandcamp is a "oui_player":https://github.com/NicolasGraph/oui_player v2+ extension to easily embed "Bandcamp":https://bandcamp.com/ provided albums and tracks in "Textpattern":https://textpattern.com/ powered websites.
...
oui_player_bandcamp's minimum requirements:
...
# "Download":https://github.com/NicolasGraph/oui_player_bandcamp/releases the compiled plugin file or the source to compile a customized file.
...
# Install oui_player_bandcamp:
@$ composer require oui/oui_player_bandcamp@
...
bc. $ composer update oui/oui_player_bandcamp
...
bc. $ composer remove oui/oui_player_bandcamp

h2. Tags and parameters

h3. oui_bandcamp vs oui_player
...
h3. oui_if_bandcamp vs oui_if_player

p. While the @<txp:oui_if_player>…</txp:oui_if_player>@ tag is able to check an URL against any URL from any extension-related provider, the @<txp:oui_if_bandcamp>…</txp:oui_if_bandcamp>@ tag is a shortcut to check an URL against Bandcamp related URL schemes only. It is strictly equivalent to @<txp:oui_if_player provider="bandcamp">…</txp:oui_if_player>@.
...
"oui_player":https://github.com/NicolasGraph/oui_player preference related field value: @https://bandcamp.com/EmbeddedPlayer/album=3819613117@.

h3. Embed a player by defining its provider and a media ID through attributes

bc(language-markup). <txp:oui_player provider="bandcamp" play="album=3819613117" />

…or:

bc(language-markup). <txp:oui_bandcamp play="album=3819613117" />

h3. Conditionally embed a player using attributes

bc(language-markup).. <txp:oui_if_player provider="bandcamp" play="https://bandcamp.com/EmbeddedPlayer/album=3819613117/track=1169742928">
    <txp:oui_player />
</txp:oui_if_player>

p. …or:

bc(language-markup).. <txp:oui_if_bandcamp play="https://bandcamp.com/EmbeddedPlayer/album=3819613117/track=1169742928">
    <txp:oui_bandcamp />
</txp:oui_if_bandcamp>
...
oui_player_bandcamp version 1.0.0, Copyright (C) 2018 Nicolas Morand
...
* *oui_player_bandcamp v1.0.0-beta* (2018-06-24)
